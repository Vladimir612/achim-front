  ...
  return (
    <div className={styles.uvpList}>
      <UvpSingle
        ...
        fullText="I'm setting up a pool of trainers, organizing events, building networks, offering online and offline further training,
        ...
        almost nothing?). I'm setting up a pool of trainers, organizing events, building networks, offering online and offline further training,
        nervous system-oriented advice and support, and setting up an attractive interactive self-study area (we're currently doing
        almost nothing?). I'm setting up a pool of trainers, organizing events, building networks, offering online and offline further training,
        nervous system-oriented advice and support, and setting up an attractive interactive self-study area (we're currently doing
        almost nothing?)"
